...
public class RouletteGUI extends JPanel implements ActionListener, ItemListener
{
	...
	private JLabel authorLabel = new JLabel("Author: Lianne Louie");
	...
	{
		//we specify content pane so that the other panes in the frame aren't destroyed
	 //formatting objects
		...
		mainFrame.setSize (500,300);
		 //so it'll stop whining that I haven't terminated
	...
	//GUI for load game screen, lists potential games to load and allows
	// user to pick based off a combobox
	...
	//gives options between each round of play to play a new round,
	// add a player or switch games
	...
	private void gameGUI()
	{
		...
		//this is going to hold player info
		JPanel playerAreaPanel = new JPanel(new GridLayout(5,1));
